 ...
 */
public class Hardware147SixMotors
{
    ...
    public DcMotor  auxA = null;
    public DcMotor  auxB = null;
    ...
    public void init(HardwareMap ahwMap) {
        ...
        auxA = hwMap.dcMotor.get("aux_a");
        auxB = hwMap.dcMotor.get("aux_b");
        ...
        auxA.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        auxB.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
    }
